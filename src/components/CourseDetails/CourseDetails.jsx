                    ...
                    <Row>
                        ...
                        <Col lg={4} md={6} sm={12}>
                            <div className="widget_feature">
                                ...
                                <hr />
                                <ul>
                                    <li><FontAwesomeIcon className="iconBullent" icon={faUser} /> <span> Matriculados :</span> 1200 alunos </li>

                                    <li><FontAwesomeIcon className="iconBullent" icon={faClock} /> <span>Duração :</span> 2 horas</li>

                                    <li><FontAwesomeIcon className="iconBullent" icon={faClipboard} /> <span>Aulas :</span> 8</li>

                                    <li><FontAwesomeIcon className="iconBullent" icon={faClone} /> <span>Categorias:</span> Tecnologia da Informação</li>

                                    <li><FontAwesomeIcon className="iconBullent" icon={faTags} /> <span>Tags:</span> Android, JavaScript</li>

                                    <li><FontAwesomeIcon className="iconBullent" icon={faCheckSquare} /> <span>Instrutor:</span> Wilker Alves</li>

                                </ul>
                                <div class="price-wrap text-center">
                                    <h5>Preço: <span>R$ 54.00</span></h5>
                                    <Button variant="warning">MATRÍCULA</Button>
                ...
                <Container>
                    <Row>
                        <Col lg={6} md={6} sm={12}>
                            ...
                            <div className="widget_feature">
                                <h1 className="coruseDetailsText"> Requisitos recomendados:  </h1>
                                <hr />
                                <ul>
